...
**Присоединяйтеся к телеграмм [каналу](https://t.me/+aDVl7FksKVc3ZmUy)**
___
# 📋 **Навигация**
...
**Yoomoney - [создать токен ](https://yoomoney.ru/myservices/new)** или **Lolz - [создать токен ](https://lolz.live/account/api)**

3\. Вести токен 
Платежная система > токен 
...
**Примечание: плагины имеют больше возможностей чем админ использование плагинов не из [телеграмм канал](https://t.me/AutoShopKorgi), создатель скпипта не несёт ответственность.**
